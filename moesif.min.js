(function() {
(function(){var ka,la,ma,na,oa,pa,qa,J,K,D,L,M,N,V,W,X,Y,Z;function ra(a,b,d){p.log("processResponse for"+a._url);var f=(new Date).toISOString();if(d){var g=a._url?a._url.toLowerCase():a._url;if(g&&0>g.indexOf("moesif.com")&&0>g.indexOf("apirequest.io")){a:if((g=a._url)&&"string"===typeof g){var e=c.trim(g);if(0!==e.indexOf("http")){g=Ma+window.location.host+"/"+e.replace(/^\./,"").replace(/^\//,"");break a}}g={uri:g,verb:a._method,time:a._startTime,headers:a._requestHeaders};if(b)if("string"===typeof b)p.log("request post data is string"),
p.log(b),b=$(b),g.transfer_encoding=b.transfer_encoding,g.body=b.body;else if("object"===typeof b||Array.isArray(b)||"number"===typeof b||"boolean"===typeof b)g.body=b;e=a.getAllResponseHeaders();p.log("rawResponseHeaders are "+e);b={};if(e)for(var e=e.split("\r\n"),i=0;i<e.length;i++){var k=e[i],h=k.indexOf(": ");if(0<h){var l=k.substring(0,h);b[l]=k.substring(h+2)}}e=a.status;1223===e&&(e=204);f={status:e,time:f,headers:b};p.log("responseType: "+a.responseType);p.log("responseText: "+a.responseText);
...
s.log(e)}}function Pa(a,b,d,c){var g=null;try{g=new Request(d,c)}catch(e){}var i=(new Date).toISOString(),k=null,h=null,h=b(d,c),l=null;return h=h.then(function(b){l=b.clone();k=(new Date).toISOString();Oa(g,l,i,k,a);return b})}function Qa(a,b){var d=b||window||self;if(d.fetch){s.log("found fetch method.");if(d.fetch.polyfill)return s.log("skip patching fetch since it is polyfilled"),null;var c=d.fetch;s.log("fetch is not polyfilled so instrumenting it");d.fetch=function(b){return function(d,c){return Pa(a,
...
c.getQueryParamByName("utmcct",d),k={},h=function(a,b){c.isEmptyString(b)||(k[a]=b)};h(V,f);h(W,g);h(X,e);h(Y,i);h(Z,d);return k}function q(a,b){return!b?a:0===a.indexOf("moesif_")?a.replace("moesif_",b):a}function Sa(a){var b=a.persistence;if("cookie"!==b&&"localStorage"!==b)j.critical("Unknown persistence type "+b+"; falling back to cookie"),b=E.persistence="localStorage";var d=a.persistence_key_prefix,f=function(b,f){var i=q(b,d);c.localStorage.set(i,f);c.cookie.set(i,f,a.cookie_expiration,a.cross_subdomain_cookie,
...
!g&&e&&"localStorage"===d&&c.localStorage.set(f,e);return g||e}return aa(c.cookie.get(f))}function xa(a){a=a&&a.persistence_key_prefix;c.cookie.remove(q(J,a));c.cookie.remove(q(K,a));c.cookie.remove(q(D,a));c.cookie.remove(q(L,a));c.cookie.remove(q(M,a));c.cookie.remove(q(N,a))}function ya(a){a=a&&a.persistence_key_prefix;c.localStorage.remove(q(J,a));c.localStorage.remove(q(K,a));c.localStorage.remove(q(D,a));c.localStorage.remove(q(L,a));c.localStorage.remove(q(M,a));c.localStorage.remove(q(N,a))}
function Ta(a){try{var b={};if(!a.disableUtm)var d=void 0,f=void 0,d=c.getUrlParams(),f=c.cookie.get("__utmz"),b=Ra(f,d)||{};if(!a.disableReferer){var g;a:{var e=document&&document.referrer;za.log(e);if(!c.isEmptyString(e))if(0===e.indexOf(location.protocol+"//"+location.host))za.log("referrer is the same so skipping");else{var i;if(c.isEmptyString(e))i=null;else{var k=e.split("/");i=3<=k.length?k[2]:null}g={referrer:e,referring_domain:i};break a}g=void 0}if(g)b.referrer=g.referrer,b.referring_domain=
g.referring_domain}if(!a.disableRGclid){var h,l=c.getUrlParams(),m=c.getQueryParamByName("gclid",l);(h=c.isEmptyString(m)?void 0:m)&&(b.gclid=h)}return b}catch(Ua){F.log(Ua)}}function Aa(a,b,d){try{if(d&&!c.isEmptyObject(d)){var f=c.JSONEncode(d);a(b,f)}}catch(g){F.error("failed to decode campaign data"),F.error(g)}}function ba(a,b){try{var d=O(a,b);if(d&&"null"!==d){var f=c.JSONDecode(d);return f&&!c.isEmptyObject(f)?f:null}}catch(g){return F.error("failed to persist campaign data"),F.error(g),null}}
function Va(a,b,d){var c=M;!ba(c,b)&&a&&Aa(a,c,d);c=N;!ba(c,b)&&a&&Aa(a,c,d)}function Ba(a,b,d){if(b=ba(d,b))try{a(d,"")}catch(c){F.error("failed to clear campaign data")}return b}function ca(a){var b=c.UUID();a&&a(D,b);return b}function Wa(a,b,d){if(d)try{var f=c.crossDomainTrackingUtils.getCrossDomainTrackingParamValue(d),g;if(g=f)g=!f||"string"!==typeof f||200<f.length||!/^[a-f0-9-]+$/i.test(f)?!1:-1===f.indexOf("-")?!1:!0;if(g)return a(D,f),c.crossDomainTrackingUtils.cleanUrlParameter(d),f;f&&
(j.error("Invalid anonymous ID format from URL parameter, ignoring"),c.crossDomainTrackingUtils.cleanUrlParameter(d))}catch(e){j.error("Error reading cross-domain tracking parameter: "+e.message)}return(b=O(D,b))?b:ca(a)}function Ca(a){try{return a.request.headers["X-Moesif-SDK"]}catch(b){return!1}}function Xa(a){if(!a)throw Error("options are required by moesif-browser-js middleware");if(!a.applicationId)throw Error("A moesif application id is required. Please obtain it through your settings at www.moesif.com");
if(a.getTags&&!c.isFunction(a.getTags))throw Error("getTags should be a function");if(a.getMetadata&&!c.isFunction(a.getMetadata))throw Error("getMetadata should be a function");if(a.getApiVersion&&!c.isFunction(a.getApiVersion))throw Error("identifyUser should be a function");if(a.maskContent&&!c.isFunction(a.maskContent))throw Error("maskContent should be a function");if(a.skip&&!c.isFunction(a.skip))throw Error("skip should be a function");}function Da(){j.log("moesif object creator is called");
return{init:function(a){window||j.critical("Warning, this library need to be initiated on the client side");Xa(a);var b={};b.getTags=a.getTags||da;b.maskContent=a.maskContent||function(a){return a};b.getMetadata=a.getMetadata||da;b.skip=a.skip||function(){return!1};b.debug=a.debug;b.callback=a.callback||da;b.applicationId=a.applicationId;b.apiVersion=a.apiVersion;b.disableFetch=a.disableFetch;b.disableReferrer=a.disableReferrer;b.disableGclid=a.disableGclid;b.disableUtm=a.disableUtm;b.eagerBodyLogging=
...
"";b.persistence_key_prefix=a.persistenceKeyPrefix;b.enableCrossDomainTracking=a.enableCrossDomainTracking||!1;b.crossDomainTargets=Object.hasOwn(a,"crossDomainTargets")?a.crossDomainTargets:[];b.crossDomainTrackingParameterName=b.enableCrossDomainTracking?a.crossDomainTrackingParameterName||"__mt":null;this.requestBatchers={};this._options=b;this._persist=Sa(b);try{if(this._userId=O(J,b),this._session=O(L,b),this._companyId=O(K,b),this._anonymousId=Wa(this._persist,b,b.crossDomainTrackingParameterName),
(this._currentCampaign=Ta(b))&&Va(this._persist,b,this._currentCampaign),this._currentCampaign&&!this._userId)a={},a.anonymous_id=this._anonymousId,a.campaign=this._currentCampaign,this.updateUser(a,this._options.applicationId,this._options.host,this._options.callback)}catch(d){j.error("error loading saved data from local storage but continue")}if(b.batchEnabled)if(!P()||!Ea)b.batchEnabled=!1,j.log("Turning off batch processing because it needs XHR and localStorage");else if(this.initBatching(),Fa&&
window.addEventListener){var f=c.bind(function(){c.each(this.requestBatchers,function(a){a.stopped||a.flush({sendBeacon:!0})})},this);window.addEventListener("pagehide",function(){f()});window.addEventListener("visibilitychange",function(){"hidden"===document.visibilityState&&f()})}j.log("moesif initiated");return this},_executeRequest:function(a,b,d,c){var g=d&&d.applicationId||this._options.applicationId,e=d&&d.method||"POST";try{var i=new XMLHttpRequest;i.open(e,a);i.setRequestHeader("Content-Type",
"application/json");i.setRequestHeader("X-Moesif-Application-Id",g);i.setRequestHeader("X-Moesif-SDK","moesif-browser-js/"+E.LIB_VERSION);if(d.timeout_ms&&"undefined"!==typeof i.timeout){i.timeout=d.timeout_ms;var k=(new Date).getTime()}i.onreadystatechange=function(){if(4===i.readyState)if(200<=i.status&&300>=i.status)c&&c(XMLHttpRequest.responseText);else{var a;a=i.timeout&&!i.status&&(new Date).getTime()-k>=i.timeout?"timeout":"Bad HTTP status: "+i.status+" "+i.statusText;j.error(a);c&&c({status:0,
error:a,xhr_req:i})}};i.send(B(b))}catch(h){j.error("failed to send to moesif "+(b&&b.request&&b.request.uri)),j.error(h),c&&c({status:0,error:h})}},initBatching:function(){var a=this._options.applicationId,b=this._options.host;j.log("does requestBatch.events exists? "+this.requestBatchers.events);if(!this.requestBatchers.events){var d={libConfig:this._options,sendRequestFunc:c.bind(function(a,b,d,c){this._executeRequest(a,b,d,c)},this),stopAllBatching:c.bind(function(){this.stopAllBatching()},this)},
f=Ga(a),a=new x("__mf_"+f+"_ev",G+b+la,d),b=new x("__mf_"+f+"_ac",G+b+ma,d);this.requestBatchers={events:a,actions:b}}c.each(this.requestBatchers,function(a){a.start()})},stopAllBatching:function(){this._options.batchEnabled=!1;c.each(this.requestBatchers,function(a){a.stop();a.clear()})},_sendOrBatch:function(a,b,d,f,g){var e=this,i=function(){return e._executeRequest(d,a,{applicationId:b},g)};if(this._options.batchEnabled&&f){j.log("current batcher storage key is  "+f.queue.storageKey);var k=c.bind(function(a){a||
(j.log("enqueue failed, send immediately"),i())},this);f.enqueue(a,k)}else return i();return!0},start:function(a){function b(a){d.recordEvent(a)}var d=this;if(this._stopRecording||this._stopWeb3Recording)return j.log("recording has already started, please call stop first."),!1;j.log("moesif starting");this._stopRecording=Na(b,this._options);if(!this._options.disableFetch)j.log("also instrumenting fetch API"),this._stopFetchRecording=Qa(b);if(this._options.enableCrossDomainTracking){j.log("enabling cross domain tracking");
var f=this._options.crossDomainTargets;null===f?(j.log("cross domain tracking is enabled for ALL domains and hyperlinks"),this._stopCrossDomainTracking=c.crossDomainTrackingUtils.decorateLinksForCrossDomainTracking(null,this._options.crossDomainTrackingParameterName,this._anonymousId)):Array.isArray(f)&&0<f.length?(j.log("decorating links for cross domain tracking on specified domains: "+f.join(", ")),this._stopCrossDomainTracking=c.crossDomainTrackingUtils.decorateLinksForCrossDomainTracking(f,this._options.crossDomainTrackingParameterName,
this._anonymousId)):j.log("cross domain tracking is enabled but no target domains specified - no links will be decorated")}this.useWeb3(a);return!0},cdtUrlDecorator:function(a,b){void 0===b&&(b=!1);return!a?a:c.crossDomainTrackingUtils.cdtUrlDecorator(a,b?null:this._options.crossDomainTargets,this._options.crossDomainTrackingParameterName,this._anonymousId,window)},useWeb3:function(a){function b(a){d.recordEvent(a)}var d=this;try{if(this._stopWeb3Recording)this._stopWeb3Recording(),this._stopWeb3Recording=
null;if(a)this._stopWeb3Recording=ua(a,b,this._options);else if(window.web3)j.log("found global web3, will capture from it"),this._stopWeb3Recording=ua(window.web3,b,this._options);if(this._stopWeb3Recording)return!0}catch(c){j.log("error patching web3, moving forward anyways"),this._options.callback&&this._options.callback({status:0,error:c,message:"failed to instrument web3, but moving forward with other instrumentation"})}return!1},updateUser:function(a,b,d,c){this._executeRequest(G+d+na,a,{applicationId:b},
c)},identifyUser:function(a,b){if(c.isNil(a))j.critical("identifyUser called with nil userId");else{this._userId=a;if(!this._options||!this._options.applicationId)throw Error("Init needs to be called with a valid application Id before calling identify User.");var d={user_id:a};b&&(d.metadata=b);if(this._session)d.session_token=this._session;var f=Ba(this._persist,this._options,M)||this._currentCampaign;f&&(d.campaign=f);if(this._companyId)d.company_id=this._companyId;d.anonymous_id=this._anonymousId;
this.updateUser(d,this._options.applicationId,this._options.host,this._options.callback);try{a&&this._persist(J,a)}catch(g){j.error("error saving to local storage")}}},updateCompany:function(a,b,d,c){this._executeRequest(G+d+oa,a,{applicationId:b},c)},identifyCompany:function(a,b,d){if(c.isNil(a))j.critical("identifyCompany called with nil companyId.");else{this._companyId=a;if(!this._options||!this._options.applicationId)throw Error("Init needs to be called with a valid application Id before calling identify User.");
var f={company_id:a};d&&(f.company_domain=d);b&&(f.metadata=b);if(this._session)f.session_token=this._session;(b=Ba(this._persist,this._options,N)||this._currentCampaign)&&(f.campaign=b);this.updateCompany(f,this._options.applicationId,this._options.host,this._options.callback);try{a&&this._persist(K,a)}catch(g){j.error("error saving to local storage")}}},identifySession:function(a){if(c.isNil(a))j.critical("identifySession called with nil");else if(this._session=a)try{this._persist(L,a)}catch(b){j.error("local storage error")}},
track:function(a,b){if(!a)throw Error("track name must have action Name defined");var d={action_name:a};if(this._companyId)d.company_id=this._companyId;this._userId?d.user_id=this._userId:d.anonymous_id=this._anonymousId;if(this._session)d.session_token=this._session;d.request={uri:document.location.href,verb:"GET",user_agent_string:navigator.userAgent};d.transaction_id=c.uuid4();b&&(d.metadata=b);var f=G+this._options.host+pa;j.log("sending or queuing: "+a);return this._sendOrBatch(d,this._options.applicationId,
f,this.requestBatchers.actions,this._options.callback)},recordEvent:function(a){if(Ca(a))j.log("skipped logging for requests to moesif");else{j.log("determining if should log: "+a.request.uri);var b=Object.assign({},a);this._getUserId()?b.user_id=this._getUserId():b.anonymous_id=this._anonymousId;this._getCompanyId()&&(b.company_id=this._getCompanyId());this._getSession()&&(b.session_token=this._getSession());b.tags=this._options.getTags(a)||"";if(this._options.apiVersion)b.request.api_version=this._options.apiVersion;
if(!b.request.headers["User-Agent"])b.request.headers["User-Agent"]=window.navigator.userAgent;b.transaction_id=c.uuid4();this._options.maskContent&&(b=this._options.maskContent(b));if(this._options.getMetadata)if(b.metadata){var d=this._options.getMetadata(b);b.metadata=Object.assign(b.metadata,d)}else b.metadata=this._options.getMetadata(b);!this._options.skip(a)&&!Ca(a)?(j.log("sending or queuing: "+a.request.uri),this._sendOrBatch(b,this._options.applicationId,G+this._options.host+qa,this.requestBatchers.events,
this._options.callback)):j.log("skipped logging for "+a.request.uri)}},_getUserId:function(){return this._userId},_getCompanyId:function(){return this._companyId},_getSession:function(){return this._session},stop:function(){if(this._stopRecording)this._stopRecording(),this._stopRecording=null;if(this._stopWeb3Recording)this._stopWeb3Recording(),this._stopWeb3Recording=null;if(this._stopFetchRecording)this._stopFetchRecording(),this._stopFetchRecording=null;if(this._stopCrossDomainTracking)this._stopCrossDomainTracking(),
this._stopCrossDomainTracking=null},clearCookies:function(){xa(this._options)},clearStorage:function(){ya(this._options)},resetAnonymousId:function(){return this._anonymousId=ca(this._persist)},reset:function(){xa(this._options);ya(this._options);this._anonymousId=ca(this._persist);this._currentCampaign=this._session=this._userId=this._companyId=null}}}var E={DEBUG:!1,LIB_VERSION:"1.8.13"},z;if("undefined"===typeof window){var y={hostname:""};z={navigator:{userAgent:""},document:{location:y,referrer:""},
screen:{width:0,height:0},location:y}}else z=window;var y=Array.prototype,u=Object.prototype,H=y.slice,Q=u.toString,S=u.hasOwnProperty,r=z.console,I=z.navigator,v=z.document,R=z.opera,T=z.screen,n=I.userAgent,ea=Function.prototype.bind,Ha=y.forEach,Ia=y.indexOf,Ja=y.map,y=Array.isArray,fa={},c={trim:function(a){return a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")}},j={log:function(){if(E.DEBUG&&!c.isUndefined(r)&&r)try{r.log.apply(r,arguments)}catch(a){c.each(arguments,function(a){r.log(a)})}},
error:function(){if(E.DEBUG&&!c.isUndefined(r)&&r){var a=["Moesif error:"].concat(c.toArray(arguments));try{r.error.apply(r,a)}catch(b){c.each(a,function(a){r.error(a)})}}},critical:function(){if(!c.isUndefined(r)&&r){var a=["Moesif error:"].concat(c.toArray(arguments));try{r.error.apply(r,a)}catch(b){c.each(a,function(a){r.error(a)})}}}},ga=function(a,b){return function(){arguments[0]="["+b+"] "+arguments[0];return a.apply(j,arguments)}},u=function(a){return{log:ga(j.log,a),error:ga(j.error,a),critical:ga(j.critical,
a)}};c.bind=function(a,b){var d,f;if(ea&&a.bind===ea)return ea.apply(a,H.call(arguments,1));if(!c.isFunction(a))throw new TypeError;d=H.call(arguments,2);return f=function(){if(!(this instanceof f))return a.apply(b,d.concat(H.call(arguments)));var c={};c.prototype=a.prototype;var e=new c;c.prototype=null;c=a.apply(e,d.concat(H.call(arguments)));return Object(c)===c?c:e}};c.bind_instance_methods=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.bind(a[b],a))};c.each=function(a,b,d){if(!(null===
a||void 0===a))if(Ha&&a.forEach===Ha)a.forEach(b,d);else if(a.length===+a.length)for(var c=0,g=a.length;c<g&&!(c in a&&b.call(d,a[c],c,a)===fa);c++);else for(c in a)if(S.call(a,c)&&b.call(d,a[c],c,a)===fa)break};c.escapeHTML=function(a){a&&c.isString(a)&&(a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"));return a};c.extend=function(a){c.each(H.call(arguments,1),function(b){for(var d in b)void 0!==b[d]&&(a[d]=b[d])});return a};c.isArray=
y||function(a){return"[object Array]"===Q.call(a)};c.isFunction=function(a){try{return/^\s*\bfunction\b/.test(a)}catch(b){return!1}};c.isArguments=function(a){return!(!a||!S.call(a,"callee"))};c.toArray=function(a){return!a?[]:a.toArray?a.toArray():c.isArray(a)||c.isArguments(a)?H.call(a):c.values(a)};c.map=function(a,b){if(Ja&&a.map===Ja)return a.map(b);var d=[];c.each(a,function(a){d.push(b(a))});return d};c.keys=function(a){var b=[];if(null===a)return b;c.each(a,function(a,c){b[b.length]=c});return b};
c.values=function(a){var b=[];if(null===a)return b;c.each(a,function(a){b[b.length]=a});return b};c.identity=function(a){return a};c.include=function(a,b){var d=!1;if(null===a)return d;if(Ia&&a.indexOf===Ia)return-1!=a.indexOf(b);c.each(a,function(a){if(d||(d=a===b))return fa});return d};c.includes=function(a,b){return-1!==a.indexOf(b)};c.inherit=function(a,b){a.prototype=new b;a.prototype.constructor=a;a.superclass=b.prototype;return a};c.isArrayBuffer=function(a){var b=Object.prototype.toString;
return"function"===typeof ArrayBuffer&&(a instanceof ArrayBuffer||"[object ArrayBuffer]"===b.call(a))};c.isObject=function(a){return a===Object(a)&&!c.isArray(a)};c.isEmptyObject=function(a){if(c.isObject(a)){for(var b in a)if(S.call(a,b))return!1;return!0}return!1};c.isEmptyString=function(a){return!a||0===a.length};c.isUndefined=function(a){return void 0===a};c.isString=function(a){return"[object String]"==Q.call(a)};c.isDate=function(a){return"[object Date]"==Q.call(a)};c.isNumber=function(a){return"[object Number]"==
Q.call(a)};c.isElement=function(a){return!!(a&&1===a.nodeType)};c.isNil=function(a){return c.isUndefined(a)||null===a};c.encodeDates=function(a){c.each(a,function(b,d){c.isDate(b)?a[d]=c.formatDate(b):c.isObject(b)&&(a[d]=c.encodeDates(b))});return a};c.timestamp=function(){Date.now=Date.now||function(){return+new Date};return Date.now()};c.formatDate=function(a){function b(a){return 10>a?"0"+a:a}return a.getUTCFullYear()+"-"+b(a.getUTCMonth()+1)+"-"+b(a.getUTCDate())+"T"+b(a.getUTCHours())+":"+b(a.getUTCMinutes())+
":"+b(a.getUTCSeconds())};c.safewrap=function(a){return function(){try{return a.apply(this,arguments)}catch(b){j.critical("Implementation error. Please turn on debug and contact support@Moesif.com."),E.DEBUG&&j.critical(b)}}};c.safewrap_class=function(a,b){for(var d=0;d<b.length;d++)a.prototype[b[d]]=c.safewrap(a.prototype[b[d]])};c.safewrap_instance_methods=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.safewrap(a[b]))};c.strip_empty_properties=function(a){var b={};c.each(a,function(a,
f){c.isString(a)&&0<a.length&&(b[f]=a)});return b};c.truncate=function(a,b){var d;"string"===typeof a?d=a.slice(0,b):c.isArray(a)?(d=[],c.each(a,function(a){d.push(c.truncate(a,b))})):c.isObject(a)?(d={},c.each(a,function(a,g){d[g]=c.truncate(a,b)})):d=a;return d};c.JSONEncode=function(){return function(a){var b=function(a){var b=/[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,c={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f",
"\r":"\\r",'"':'\\"',"\\":"\\\\"};b.lastIndex=0;return b.test(a)?'"'+a.replace(b,function(a){var b=c[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'},c=function(a,g){var e="",i=0,k=i="",k=0,h=e,l=[],m=g[a];m&&"object"===typeof m&&"function"===typeof m.toJSON&&(m=m.toJSON(a));switch(typeof m){case "string":return b(m);case "number":return isFinite(m)?""+m:"null";case "boolean":case "null":return""+m;case "object":if(!m)return"null";e+="    ";l=[];
if("[object Array]"===Q.apply(m)){k=m.length;for(i=0;i<k;i+=1)l[i]=c(i,m)||"null";return k=0===l.length?"[]":e?"[\n"+e+l.join(",\n"+e)+"\n"+h+"]":"["+l.join(",")+"]"}for(i in m)S.call(m,i)&&(k=c(i,m))&&l.push(b(i)+(e?": ":":")+k);return k=0===l.length?"{}":e?"{"+l.join(",")+""+h+"}":"{"+l.join(",")+"}"}};return c("",{"":a})}}();c.JSONDecode=function(){var a,b,c={'"':'"',"\\":"\\","/":"/",b:"\u0008",f:"\u000c",n:"\n",r:"\r",t:"\t"},f,g=function(b){b=new SyntaxError(b);b.at=a;b.text=f;throw b;},e=function(c){c&&
c!==b&&g("Expected '"+c+"' instead of '"+b+"'");b=f.charAt(a);a+=1;return b},i=function(){var a;a="";"-"===b&&(a="-",e("-"));for(;"0"<=b&&"9">=b;)a+=b,e();if("."===b)for(a+=".";e()&&"0"<=b&&"9">=b;)a+=b;if("e"===b||"E"===b){a+=b;e();if("-"===b||"+"===b)a+=b,e();for(;"0"<=b&&"9">=b;)a+=b,e()}a=+a;if(isFinite(a))return a;g("Bad number")},k=function(){var a,f,h="",i;if('"'===b)for(;e();){if('"'===b)return e(),h;if("\\"===b)if(e(),"u"===b){for(f=i=0;4>f;f+=1){a=parseInt(e(),16);if(!isFinite(a))break;
i=16*i+a}h+=String.fromCharCode(i)}else if("string"===typeof c[b])h+=c[b];else break;else h+=b}g("Bad string")},h=function(){for(;b&&" ">=b;)e()},l=function(){switch(b){case "t":return e("t"),e("r"),e("u"),e("e"),!0;case "f":return e("f"),e("a"),e("l"),e("s"),e("e"),!1;case "n":return e("n"),e("u"),e("l"),e("l"),null}g('Unexpected "'+b+'"')},m;m=function(){h();switch(b){case "{":var a;a:{var c,d={};if("{"===b){e("{");h();if("}"===b){e("}");a=d;break a}for(;b;){c=k();h();e(":");Object.hasOwnProperty.call(d,
c)&&g('Duplicate key "'+c+'"');d[c]=m();h();if("}"===b){e("}");a=d;break a}e(",");h()}}g("Bad object")}return a;case "[":a:{a=[];if("["===b){e("[");h();if("]"===b){e("]");c=a;break a}for(;b;){a.push(m());h();if("]"===b){e("]");c=a;break a}e(",");h()}}g("Bad array")}return c;case '"':return k();case "-":return i();default:return"0"<=b&&"9">=b?i():l()}};return function(c){f=c;a=0;b=" ";c=m();h();b&&g("Syntax error");return c}}();c.base64Encode=function(a){var b,d,f,g,e=0,i=0,k="",k=[];if(!a)return a;
a=c.utf8Encode(a);do b=a.charCodeAt(e++),d=a.charCodeAt(e++),f=a.charCodeAt(e++),g=b<<16|d<<8|f,b=g>>18&63,d=g>>12&63,f=g>>6&63,g&=63,k[i++]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g);while(e<a.length);k=k.join("");switch(a.length%3){case 1:k=
k.slice(0,-2)+"==";break;case 2:k=k.slice(0,-1)+"="}return k};c.utf8Encode=function(a){var a=(a+"").replace(/\r\n/g,"\n").replace(/\r/g,"\n"),b="",c,f,g=0,e;c=f=0;g=a.length;for(e=0;e<g;e++){var i=a.charCodeAt(e),k=null;128>i?f++:k=127<i&&2048>i?String.fromCharCode(i>>6|192,i&63|128):String.fromCharCode(i>>12|224,i>>6&63|128,i&63|128);null!==k&&(f>c&&(b+=a.substring(c,f)),b+=k,c=f=e+1)}f>c&&(b+=a.substring(c,a.length));return b};c.UUID=function(){var a=function(){function a(b,c){var d,e=0;for(d=0;d<
c.length;d++)e|=g[d]<<8*d;return b^e}var c,f,g=[],e=0;for(c=0;c<n.length;c++)f=n.charCodeAt(c),g.unshift(f&255),4<=g.length&&(e=a(e,g),g=[]);0<g.length&&(e=a(e,g));return e.toString(16)};return function(){for(var b=(T.height*T.width).toString(16),c=1*new Date,f=0;c==1*new Date;)f++;return c.toString(16)+f.toString(16)+"-"+Math.random().toString(16).replace(".","")+"-"+a()+"-"+b}}();c.uuid4=function(){var a=URL.createObjectURL(new Blob),b=a.toString();URL.revokeObjectURL(a);return b.split(/[:\/]/g).pop().toLowerCase()};
c.isBlockedUA=function(a){return/(google web preview|baiduspider|yandexbot|bingbot|googlebot|yahoo! slurp)/i.test(a)?!0:!1};c.HTTPBuildQuery=function(a,b){var d,f,g=[];c.isUndefined(b)&&(b="&");c.each(a,function(a,b){d=encodeURIComponent(a.toString());f=encodeURIComponent(b);g[g.length]=f+"="+d});return g.join(b)};c.getUrlParams=function(){var a;if(a=location)if(!(a=location.search))a:{if(a=location.href){var b=a.indexOf("?");if(0<=b){a=a.substring(b);break a}}a=""}return a};c.getQueryParamByName=
...
function(a,b){var c=a.match(RegExp(b+"=([^&]*)"));return c?c[1]:null};c.cookie={get:function(a){for(var a=a+"=",b=v.cookie.split(";"),c=0;c<b.length;c++){for(var f=b[c];" "==f.charAt(0);)f=f.substring(1,f.length);if(0===f.indexOf(a))return decodeURIComponent(f.substring(a.length,f.length))}return null},parse:function(a){var b;try{b=c.JSONDecode(c.cookie.get(a))||{}}catch(d){}return b},set_seconds:function(a,b,c,f,g,e,i){var k="",h="",l="";i?k="; domain="+i:f&&(k=(k=Ka(v.location.hostname))?"; domain=."+
k:"");c&&(h=new Date,h.setTime(h.getTime()+1E3*c),h="; expires="+h.toGMTString());e&&(g=!0,l="; SameSite=None");g&&(l+="; secure");v.cookie=a+"="+encodeURIComponent(b)+h+"; path=/"+k+l},set:function(a,b,c,f,g,e,i){var k="",h="",l="";i?k="; domain="+i:f&&(k=(k=Ka(v.location.hostname))?"; domain=."+k:"");c&&(h=new Date,h.setTime(h.getTime()+864E5*c),h="; expires="+h.toGMTString());e&&(g=!0,l="; SameSite=None");g&&(l+="; secure");a=a+"="+encodeURIComponent(b)+h+"; path=/"+k+l;return v.cookie=a},remove:function(a,
b,d){c.cookie.set(a,"",-1,b,!1,!1,d)}};var ha=null,P=function(a,b){if(null!==ha&&!b)return ha;var c=!0;try{var a=a||window.localStorage,f="__mplss_"+ia(8);a.setItem(f,"xyz");"xyz"!==a.getItem(f)&&(c=!1);a.removeItem(f)}catch(g){c=!1}return ha=c};c.localStorage={is_supported:function(a){(a=P(null,a))||j.error("localStorage unsupported; falling back to cookie store");return a},error:function(a){j.error("localStorage error: "+a)},get:function(a){try{return window.localStorage.getItem(a)}catch(b){c.localStorage.error(b)}return null},
parse:function(a){try{return c.JSONDecode(c.localStorage.get(a))||{}}catch(b){}return null},set:function(a,b){try{window.localStorage.setItem(a,b)}catch(d){c.localStorage.error(d)}},remove:function(a){try{window.localStorage.removeItem(a)}catch(b){c.localStorage.error(b)}}};c.register_event=function(){function a(a,f,g){return function(e){if(e=e||b(window.event)){var i=!0,k;c.isFunction(g)&&(k=g(e));e=f.call(a,e);if(!1===k||!1===e)i=!1;return i}}}function b(a){if(a)a.preventDefault=b.preventDefault,
a.stopPropagation=b.stopPropagation;return a}b.preventDefault=function(){this.returnValue=!1};b.stopPropagation=function(){this.cancelBubble=!0};return function(b,c,g,e,i){b?b.addEventListener&&!e?b.addEventListener(c,g,!!i):(c="on"+c,b[c]=a(b,g,b[c])):j.error("No valid element provided to register_event")}}();var Ya=/^(\w*)\[(\w+)([=~\|\^\$\*]?)=?"?([^\]"]*)"?\]$/;c.dom_query=function(){function a(a,b){var c;return 0<=(" "+a.className+" ").replace(d," ").indexOf(" "+b+" ")}function b(b){if(!v.getElementsByTagName)return[];
var b=b.split(" "),d,e,i,k,h,l,m,j=[v];for(k=0;k<b.length;k++)if(d=b[k].replace(/^\s+/,"").replace(/\s+$/,""),-1<d.indexOf("#")){e=d.split("#");d=e[0];j=v.getElementById(e[1]);if(!j||d&&j.nodeName.toLowerCase()!=d)return[];j=[j]}else if(-1<d.indexOf(".")){e=d.split(".");d=e[0];var n=e[1];d||(d="*");e=[];for(h=i=0;h<j.length;h++){m="*"==d?j[h].all?j[h].all:j[h].getElementsByTagName("*"):j[h].getElementsByTagName(d);for(l=0;l<m.length;l++)e[i++]=m[l]}j=[];for(h=d=0;h<e.length;h++)e[h].className&&c.isString(e[h].className)&&
a(e[h],n)&&(j[d++]=e[h])}else if(e=d.match(Ya)){d=e[1];var o=e[2],n=e[3],p=e[4];d||(d="*");e=[];for(h=i=0;h<j.length;h++){m="*"==d?j[h].all?j[h].all:j[h].getElementsByTagName("*"):j[h].getElementsByTagName(d);for(l=0;l<m.length;l++)e[i++]=m[l]}j=[];d=0;switch(n){case "=":n=function(a){return a.getAttribute(o)==p};break;case "~":n=function(a){return a.getAttribute(o).match(RegExp("\\b"+p+"\\b"))};break;case "|":n=function(a){return a.getAttribute(o).match(RegExp("^"+p+"-?"))};break;case "^":n=function(a){return 0===
a.getAttribute(o).indexOf(p)};break;case "$":n=function(a){return a.getAttribute(o).lastIndexOf(p)==a.getAttribute(o).length-p.length};break;case "*":n=function(a){return-1<a.getAttribute(o).indexOf(p)};break;default:n=function(a){return a.getAttribute(o)}}j=[];for(h=d=0;h<e.length;h++)n(e[h])&&(j[d++]=e[h])}else{e=[];for(h=i=0;h<j.length;h++){m=j[h].getElementsByTagName(d);for(l=0;l<m.length;l++)e[i++]=m[l]}j=e}return j}var d=/[\t\r\n]/g;return function(a){return c.isElement(a)?[a]:c.isObject(a)&&
...
/WPDesktop/.test(a)?"Windows Phone":/iPad/.test(a)?"iPad":/iPod/.test(a)?"iPod Touch":/iPhone/.test(a)?"iPhone":/(BlackBerry|PlayBook|BB10)/i.test(a)?"BlackBerry":/Android/.test(a)?"Android":""},referringDomain:function(a){a=a.split("/");return 3<=a.length?a[2]:""},properties:function(){return c.extend(c.strip_empty_properties({$os:c.info.os(),$browser:c.info.browser(n,I.vendor,R),$referrer:v.referrer,$referring_domain:c.info.referringDomain(v.referrer),$device:c.info.device(n)}),{$current_url:z.location.href,
$browser_version:c.info.browserVersion(n,I.vendor,R),$screen_height:T.height,$screen_width:T.width,mp_lib:"web",$lib_version:E.LIB_VERSION,$insert_id:ia(),time:c.timestamp()/1E3})},people_properties:function(){return c.extend(c.strip_empty_properties({$os:c.info.os(),$browser:c.info.browser(n,I.vendor,R)}),{$browser_version:c.info.browserVersion(n,I.vendor,R)})},pageviewInfo:function(a){return c.strip_empty_properties({mp_page:a,mp_referrer:v.referrer,mp_browser:c.info.browser(n,I.vendor,R),mp_platform:c.info.os()})}};
...
"http://":"https://",t=u("web3capture"),s=u("capture fetch"),za=u("referrer"),wa=u("utm");V="utm_source";W="utm_medium";X="utm_campaign";Y="utm_term";Z="utm_content";J="moesif_stored_user_id";K="moesif_stored_company_id";L="moesif_stored_session_id";D="moesif_anonymous_id";M="moesif_campaign_data";N="moesif_campaign_company";var F=u("campaign"),ab=u("lock"),La=function(a,b){b=b||{};this.storageKey=a;this.storage=b.storage||window.localStorage;this.pollIntervalMS=b.pollIntervalMS||100;this.timeoutMS=
b.timeoutMS||2E3};La.prototype.withLock=function(a,b,c){!c&&"function"!==typeof b&&(c=b,b=null);var f=c||(new Date).getTime()+"|"+Math.random(),g=(new Date).getTime(),e=this.storageKey,i=this.pollIntervalMS,k=this.timeoutMS,h=this.storage,j=e+":X",m=e+":Y",n=e+":Z",o=function(a){(new Date).getTime()-g>k?(ab.error("Timeout waiting for mutex on "+e+"; clearing lock. ["+f+"]"),h.removeItem(n),h.removeItem(m),q()):setTimeout(function(){try{a()}catch(c){b&&b(c)}},i*(Math.random()+0.1))},p=function(a,b){a()?
b():o(function(){p(a,b)})},s=function(){var a=h.getItem(m);if(a&&a!==f)return!1;h.setItem(m,f);if(h.getItem(m)===f)return!0;if(!P(h,!0))throw Error("localStorage support dropped while acquiring lock");return!1},q=function(){h.setItem(j,f);p(s,function(){h.getItem(j)===f?r():o(function(){h.getItem(m)!==f?q():p(function(){return!h.getItem(n)},r)})})},r=function(){h.setItem(n,"1");try{a()}finally{h.removeItem(n),h.getItem(m)===f&&h.removeItem(m),h.getItem(j)===f&&h.removeItem(j)}};try{if(P(h,!0))q();
...
"/v1/events";la="/v1/events/batch";pa="/v1/actions";ma="/v1/actions/batch";na="/v1/users";oa="/v1/companies";var Ea=window.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest;!Ea&&-1===n.indexOf("MSIE")&&n.indexOf("Mozilla");var da=function(){},Fa=null;navigator.sendBeacon&&(Fa=function(){return navigator.sendBeacon.apply(navigator,arguments)});var G="http:"===(document&&document.location.protocol)?"http://":"https://";window.moesif=Da();window.moesif["new"]=Da})();
})();
