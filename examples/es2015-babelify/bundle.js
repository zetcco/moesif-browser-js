...
var _loaderModule = _interopRequireDefault(require("../../src/loader-module"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
_loaderModule["default"].init({
  applicationId: 'Your Application ID'
});
_loaderModule["default"].start();
...
function getAnonymousId(persist, opt, cdtParamName) {
  ...
  if (cdtParamName) {
    // if cross domain tracking is enabled
    try {
      var anonIdFromCrossDomainTracking = _utils._.crossDomainTrackingUtils.getCrossDomainTrackingParamValue(cdtParamName);
      if (anonIdFromCrossDomainTracking && isValidAnonymousId(anonIdFromCrossDomainTracking)) {
        persist(_persistence.STORAGE_CONSTANTS.STORED_ANONYMOUS_ID, anonIdFromCrossDomainTracking);
        // Clean the URL parameter after persisting to prevent pollution
        _utils._.crossDomainTrackingUtils.cleanUrlParameter(cdtParamName);
        return anonIdFromCrossDomainTracking;
      } else if (anonIdFromCrossDomainTracking) {
        // Invalid format detected
        _utils.console.log('Invalid anonymous ID format from URL parameter, ignoring');
        // Clean the invalid parameter from URL
        _utils._.crossDomainTrackingUtils.cleanUrlParameter(cdtParamName);
      } else {
        // No parameter found, nothing to do
        _utils.console.log('No anonymous ID found in URL parameter for cross-domain tracking');
      }
    } catch (err) {
      _utils.console.log('Error reading cross-domain tracking parameter: ' + err.message);
    }
  }
...
},{"./persistence":12,"./utils":17}],3:[function(require,module,exports){
"use strict";
...
var _utils = require("./utils");
var _referrer = _interopRequireDefault(require("./referrer"));
...
function getCampaignDataFromUrlOrCookie(opt) {
  try {
    ...
    if (!opt.disableReferer) {
      var referrer = (0, _referrer["default"])();
      if (referrer) {
...
},{"./persistence":12,"./referrer":13,"./utils":17,"./utm":18}],4:[function(require,module,exports){
"use strict";
...
var _default = exports["default"] = patch;

},{"./parsers":11,"./utils":17}],5:[function(require,module,exports){
"use strict";
  ...
  if (recorder) {
    ...
    if (myUrl && myUrl.indexOf('moesif.com') < 0 && myUrl.indexOf('apirequest.io') < 0) {
      ...
      if (postData) {
        ...
        } else if (_typeof(postData) === 'object' || Array.isArray(postData) || typeof postData === 'number' || typeof postData === 'boolean') {
...
var _default = exports["default"] = captureXMLHttpRequest;

},{"./parsers":11,"./utils":17}],6:[function(require,module,exports){
"use strict";
...
function isSameOrigin(urlObj, env) {
  ...
  try {
    ...
    return urlObj.hostname === myenv.location.hostname && urlObj.protocol === myenv.location.protocol && urlObj.port === myenv.location.port;
  }
}
...
_utils._.crossDomainTrackingUtils = {
...
var _default = exports["default"] = moesif;

},{"./moesif-core":9}],9:[function(require,module,exports){
"use strict";
...
var _moesif = _interopRequireDefault(require("./moesif"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
/* eslint camelcase: "off" */
 ...
 */
/** @const */
var PRIMARY_INSTANCE_NAME = 'moesif';

// var DOM_LOADED = false;

function init_from_snippet() {
  init_type = INIT_SNIPPET;
  window[PRIMARY_INSTANCE_NAME] = (0, _moesif["default"])();
  window[PRIMARY_INSTANCE_NAME]['new'] = _moesif["default"];
}
function init_as_module() {
  init_type = INIT_MODULE;
  var instance = (0, _moesif["default"])();
  instance['new'] = _moesif["default"];
  return instance;
}

},{"./moesif":10}],10:[function(require,module,exports){
"use strict";
...
var _web3capture = _interopRequireDefault(require("./web3capture"));
var _captureFetch = _interopRequireDefault(require("./capture-fetch"));
var _crossDomainTracking = _interopRequireDefault(require("./cross-domain-tracking"));
  ...
  return {
    'init': function init(options) {
      ...
      try {
        ...
        this._anonymousId = (0, _anonymousId.getAnonymousId)(this._persist, ops, ops.crossDomainTrackingParameterName);
    ...
    _executeRequest: function _executeRequest(url, data, options, callback) {
      ...
      try {
        ...
        xmlhttp.setRequestHeader('X-Moesif-SDK', 'moesif-browser-js/' + _config["default"].LIB_VERSION);
    ...
    _loadPersistedQueue: function _loadPersistedQueue() {
      try {
        var persistedQueue = (0, _persistence.getFromPersistence)(_persistence.STORAGE_CONSTANTS.STORED_PENDING_REQUESTS, this._options);
        if (persistedQueue) {
    ...
    _savePersistedQueue: function _savePersistedQueue() {
      try {
        ...
        this._persist(_persistence.STORAGE_CONSTANTS.STORED_PENDING_REQUESTS, JSON.stringify(serializableQueue));
      } catch (err) {
    ...
    _clearPersistedQueue: function _clearPersistedQueue() {
      try {
        this._persist(_persistence.STORAGE_CONSTANTS.STORED_PENDING_REQUESTS, '');
      } catch (err) {
    ...
    'cdtUrlDecorator': function cdtUrlDecorator(url, overrideDomains) {
      ...
      return _utils._.crossDomainTrackingUtils.cdtUrlDecorator(url, decoratableDomains, this._options.crossDomainTrackingParameterName, this._anonymousId, window);
    },
    'useWeb3': function useWeb3(passedInWeb3) {
      ...
      try {
        ...
        if (passedInWeb3) {
          this._stopWeb3Recording = (0, _web3capture["default"])(passedInWeb3, recorder, this._options);
        } else if (window['web3']) {
          // try to patch the global web3
          _utils.console.log('found global web3, will capture from it');
          this._stopWeb3Recording = (0, _web3capture["default"])(window['web3'], recorder, this._options);
        }
        if (this._stopWeb3Recording) {
        ...
        if (this._options.callback) {
          this._options.callback({
            status: 0,
            error: err,
            message: 'failed to instrument web3, but moving forward with other instrumentation'
          });
        }
      }
      return false;
    ...
    'track': function track(actionName, metadata) {
      ...
      actionObject['request'] = {
        ...
        'verb': 'GET',
        // for UI events on a current page, the current page verb is always get
...
},{"./anonymousId":2,"./campaign":3,"./capture":5,"./capture-fetch":4,"./config":6,"./cross-domain-tracking":7,"./persistence":12,"./request-batcher":14,"./utils":17,"./web3capture":19}],11:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.attemptParseText = exports.attemptParseBuffer = void 0;
var _utils = require("./utils");
// eslint-disable-line camelcase

var logger = (0, _utils.console_with_prefix)('parsers');
var attemptParseText = exports.attemptParseText = function attemptParseText(text) {
  try {
    return {
      'body': _utils._.JSONDecode(text)
    };
  } catch (err) {
 ...
 * with body filled in.
 */
var attemptParseBuffer = exports.attemptParseBuffer = function attemptParseBuffer(buffer) {
  if (!buffer) return {};
...
var _utils = require("./utils");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
var STORAGE_CONSTANTS = exports.STORAGE_CONSTANTS = {
...
function getPersistenceFunction(opt) {
  ...
  if (storageType !== 'cookie' && storageType !== 'localStorage') {
    ...
    storageType = _config["default"]['persistence'] = 'localStorage';
  }
  ...
  if (storageType === 'cookie' || !_utils._.localStorage.is_supported()) {
    setFunction = function setFunction(key, value) {
      var resolvedKey = replacePrefix(key, prefix);
      _utils._.cookie.set(resolvedKey, value, opt['cookie_expiration'], opt['cross_subdomain_cookie'], opt['secure_cookie'], opt['cross_site_cookie'], opt['cookie_domain']);
    };
  }
...
var _default = exports["default"] = getReferrer;
 ...
 * @constructor
 */
var RequestBatcher = exports.RequestBatcher = function RequestBatcher(storageKey, endpoint, options) {
...
},{"./request-queue":15,"./utils":17}],15:[function(require,module,exports){
"use strict";
 ...
 * @constructor
 */
var RequestQueue = exports.RequestQueue = function RequestQueue(storageKey, options) {
  options = options || {};
...
},{"./shared-lock":16,"./utils":17}],16:[function(require,module,exports){
"use strict";
 ...
 * @constructor
 */
var SharedLock = exports.SharedLock = function SharedLock(key, options) {
  options = options || {};
  this.storageKey = key;
  this.storage = options.storage || window.localStorage;
...
SharedLock.prototype.withLock = function (lockedCB, errorCB, pid) {
  ...
  var _waitFor = function waitFor(predicate, cb) {
    if (predicate()) {
      cb();
    } else {
      delay(function () {
        _waitFor(predicate, cb);
      });
    }
  };
...
exports.window = exports.userAgent = exports.quick_hash = exports.navigator = exports.localStorageSupported = exports.extract_domain = exports.document = exports.determine_eligibility = exports.console_with_prefix = exports.console = exports.cheap_guid = exports._ = exports.JSONStringify = exports.JSONParse = void 0;
var _config = _interopRequireDefault(require("./config"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); } /* eslint camelcase: "off", eqeqeq: "off" */
...
var ArrayProto = Array.prototype,
  ...
  navigator = exports.navigator = win.navigator,
  document = exports.document = win.document,
  windowOpera = win.opera,
  screen = win.screen,
  userAgent = exports.userAgent = navigator.userAgent;
...
var console_with_prefix = exports.console_with_prefix = function console_with_prefix(prefix) {
  return {
...
_.JSONEncode = function () {
  return function (mixed_val) {
    ...
    var _str = function str(key, holder) {
      var gap = '';
      var indent = '    ';
...
var localStorageSupported = exports.localStorageSupported = function localStorageSupported(storage, forceCheck) {
...
var cheap_guid = exports.cheap_guid = function cheap_guid(maxlen) {
  var guid = Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10);
  return maxlen ? guid.substring(0, maxlen) : guid;
};
var quick_hash = exports.quick_hash = function quick_hash(str) {
 ...
 */
var determine_eligibility = exports.determine_eligibility = _.safewrap(function (str, feature, percent_allowed) {
  str = str + feature;
 ...
 * // 'example.com'
 */
var extract_domain = exports.extract_domain = function extract_domain(hostname) {
...
var JSONStringify = exports.JSONStringify = null,
  JSONParse = exports.JSONParse = null;
...
exports.UTMConstants = void 0;
exports.getUtm = getUtm;
var _utils = require("./utils");
// eslint-disable-line

var logger = (0, _utils.console_with_prefix)('utm');
var UTMConstants = exports.UTMConstants = {
  // UTM Params
...
function createEventModel(provider, startTime, endTime, payload, result, error) {
  ...
  if (payload) {
    ...
    } else if (_typeof(payload) === 'object' || Array.isArray(payload) || typeof payload === 'number' || typeof postData === 'boolean') {
...
var _default = exports["default"] = captureWeb3Requests;
