(function () {
    ...
    function decorator(url, decoratableDomains, trackingParam, trackingValue) {
    ...
    function moesifCreator () {
      ...
      return {
        'init': function (options) {
          ...
          ops.crossDomainTrackingParameterName = ops.enableCrossDomainTracking ? 
                                                  (options['crossDomainTrackingParameterName'] || '__mt') : null;
        ...
        'cdtUrlDecorator': function (url, overrideDomains = false) {
          ...
          return decorator(url, decoratableDomains, this._options.crossDomainTrackingParameterName, this._anonymousId);
        },
